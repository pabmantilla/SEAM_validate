"""Merge per-chunk ISM outputs into {SEQ_ID}.h5 -- 200K variant.

Identical to seam_scripts/single_seq/merge_ism_chunks.py but operates on
results/single_seq/ism_200k/.
