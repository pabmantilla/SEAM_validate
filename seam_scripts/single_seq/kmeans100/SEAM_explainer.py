"""SEAM k-means clustering + MetaExplainer at 100 clusters for the 100K K562 lib.

Identical to seam_scripts/single_seq/SEAM_explainer.py but defaults to 100
k-means clusters and writes to a distinct output directory
(results/single_seq/foregrounds_kmeans100) so the original 50-cluster
...
OUT_DIR = PROJ_ROOT / "results/single_seq/foregrounds_kmeans100"
